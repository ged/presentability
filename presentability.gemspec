# -*- encoding: utf-8 -*-
# stub: presentability 0.1.0.pre.20220807214309 ruby lib

Gem::Specification.new do |s|
  s.name = "presentability".freeze
  s.version = "0.1.0.pre.20220807214309"
  ...
  s.files = ["History.md".freeze, "LICENSE.txt".freeze, "README.md".freeze, "lib/presentability.rb".freeze, "lib/presentability/presenter.rb".freeze, "spec/presentability_spec.rb".freeze, "spec/spec_helper.rb".freeze]
